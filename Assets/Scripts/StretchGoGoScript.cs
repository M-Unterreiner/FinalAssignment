...
public class StretchGoGoScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        float outermostRegion = 0.35f;
        float hapticRegion = 0.2f;

        if (distanceHandHead >= hapticRegion)
        {
            moveHandNonIsomorphic(distanceHandHead, rightHandCenter, rightHand, head, isomorphicDistance, 25.0f);
        } else if (distanceHandHead >= outermostRegion)
        {
            moveHandNonIsomorphic(distanceHandHead, rightHandCenter, rightHand, head, isomorphicDistance, 50.0f);
        }
        else
        {
